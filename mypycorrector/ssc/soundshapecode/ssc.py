...
def generateHanziSSCFile(): 
    ...
    writeFilePath = pkg_resources.resource_filename(__name__, "../zh_data/hanzi_ssc_res_test.txt")
...
if __name__=="__main__":
    ...
    print(pinyinStr2)
    """
    # generateHanziSSCFile()
    getHanziStructureDict()
    soundCode = getSoundCode('传')
    shapeCode = getShapeCode('传')
    ssc = "".join(soundCode+shapeCode)
