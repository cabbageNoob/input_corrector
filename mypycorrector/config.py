...
# language model path
language_model_path = os.path.join(pwd_path, 'data/kenlm/people2014_char.klm')#people2014corpus_chars.klm  #THUCNews_char.klm  #THUCNews_people2014_merge_char.klm
